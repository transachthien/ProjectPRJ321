<%-- 
    Document   : yourProductBuy
    Created on : Jul 14, 2021, 6:16:47 PM
    Author     : trans
--%>
...
<html>
    ...
    <body>
        ...
        <h1>Your Product Buy</h1>
        <h1 style="color: red">${msg}</h1>
        <form:form action="${request.contextPath}/spring-login/buyProduct" method="POST">
        <%int i=0;%>
        <table border="1">
            <th>ID</th>
            <th>Product Name</th>
